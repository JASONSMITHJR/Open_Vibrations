...
\subsubsection{Base excitation}
\todo{add nodes on base excitation, }

% good notes are in Rao 4.5.3
...
\end{example}  
		...
		\begin{vibration_case_studies}
			...
			\begin{figure}[H]
				...
				\caption{Tapered chimney with wind bands at a Weaving Factory in the UK \bl{P Flannagan / Large Chimney Stack of the disused Weaving Factory, Donaghcloney. / CC BY-SA 2.0}}
			\end{figure}	
