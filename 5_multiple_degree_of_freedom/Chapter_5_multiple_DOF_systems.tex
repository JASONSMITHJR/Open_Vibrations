...
\begin{figure}[H]
	...
	\caption{Deflection of a vertical cantilever is a function of the considered mode shapes $\phi_n$ and their corresponding \rd{participation factors $Y_n$. should be q? $\phi_n$ should be $u$, need vector notation.} }
