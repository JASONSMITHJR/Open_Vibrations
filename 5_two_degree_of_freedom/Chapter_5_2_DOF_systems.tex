...
\begin{figure}[H]
	...
	\caption{A Beechcraft Baron in flight along with the Free-Free 3-DOF model simplified as a mass-spring model. Image sourced from the San Diego Air \& Space Museum Archives, Public Domain.}
...
\begin{equation}
\omega_n^2 M \vec{v}_n = K  \vec{v}_n
\end{equation}
