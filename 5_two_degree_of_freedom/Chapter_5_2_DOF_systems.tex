...
\todo{need test on P and more Eigen value stuff}
...
\begin{eqnarray}
P = [ \textbf{v}_1 \; \; \textbf{v}_2 \; \; \textbf{v}_3 \cdots \textbf{v}_n]
\end{eqnarray}
...
\lstinputlisting[caption = {Sample code from Matlab}]{matlab_eigenvalue_problem.m}
...
\lstinputlisting[caption = {Sample code from Matlab}]{matlab_roots_of_quartic_equation.m}
\end{example}


\begin{example}
\textbf{Roots of Quadratic Equation}
\lstinputlisting[caption = {Function for Matlab code}]{matlab_function_dfunc.m}
\lstinputlisting[caption = {Sample code from Matlab}]{matlab_temporal_response.m}
\end{example}
