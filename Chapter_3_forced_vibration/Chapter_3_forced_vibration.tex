...
\begin{document}
	...
	\section{Forced Vibrations}
			...
			Mechanical systems are subjected to external loading. For example, a piston in an engine when forced up and down by a crankshaft or a seat in an airplane may vibrate due to the movement of the jet engines transmitted through the aircraft structure.  
...
\end{example}
		...
		\begin{vibration_case_studies}
			Discuss the Millennium bridge damping issues, note that 37 energy dissipating dampers were used to control the horizontal movement of the bridge while another 52 inertial dampers were used mitigate vertical movement. The key point is how people walking caused feedback to the system.
			\begin{figure}[H]
				\centering
