...
\begin{document}
	...
	\subsection{Damping}
		...
		\begin{vibration_case_studies}
			Discuss Noise, vibration, and harshness, maybe an automotive example. Need to take my own picture of a epoxy-based damper on a car panel.
		...
		\begin{vibration_case_studies}
			...
			\begin{figure}[H]
				...
				\caption{ Sayano Shushenskaya's turbine hall before the accident where the turbine that failed is in the very foreground of the image. \bl{4044415 ???????:  ?????? ?????? English:  Andrey Korzun, CC BY-SA 3.0 <https://creativecommons.org/licenses/by-sa/3.0>, via Wikimedia Commons}}
			\end{figure}

			\begin{figure}[H]
				\centering
				\includegraphics[width=4in]{../figures/Sayano-Shushenskaya_HPS_-_generator_hall_post-accident}
				\caption{Sayano Shushenskaya's turbine hall after the accident. \bl{The original source of this photograph is believed to be Jaffaa, a user of forums.drom.ru, who uploaded it on August 17 2009, a few hours after the accident. This image is a faithful digitisation of a unique historic image, and the copyright for it is most likely held by the person who created the image or the agency employing the person. It is believed that the use of this image may qualify as fair use under the Copyright law of the United States.} }
			\end{figure}
